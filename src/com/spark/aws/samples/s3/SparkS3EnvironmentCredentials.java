...
/**
 * Sample program showing command line AWS credentials to fetch data from S3
 * bucket.
 * 
 * @author Satish Pandey
 *
 */
public class SparkS3EnvironmentCredentials {

	private final static Logger logger = LogManager.getLogger(SparkS3EnvironmentCredentials.class);
